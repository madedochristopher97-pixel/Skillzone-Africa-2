      ...
      <nav className="flex items-center justify-between gap-6 max-w-7xl mx-auto px-8 py-4">
        ...
        <div className="hidden lg:flex items-center flex-grow gap-6">
          ...
          <div className="relative group">
            <Link to="/courses" className="flex items-center gap-1.5 text-[#00113a] font-semibold text-sm font-body hover:opacity-80 transition-opacity py-2">
              Browse
        ...
        <div className="hidden lg:flex items-center gap-6 ml-auto whitespace-nowrap">
          {isAuthenticated ? (
            <>
              <Link to="/learner-dashboard" className="text-[#00113a] font-bold text-sm hover:underline">My Learning</Link>
              <button className="text-[#00113a] hover:text-[#ffbf00] transition-colors relative">
                <Bell size={20} />
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-[#c5c6d2]/20 overflow-hidden z-50">
            ...
            <>
              <Link to="/auth" state={{ isSignUp: false }} className="text-[#00113a] font-bold text-sm hover:underline">Sign In</Link>
              <Link to="/auth" state={{ isSignUp: true }} className="bg-[#ffbf00] text-[#6d5000] px-6 py-2.5 rounded-lg font-bold text-sm transition-transform active:scale-95 shadow-sm hover:bg-[#ffdfa0]">
                Sign Up
              </Link>
            </>
          )}
