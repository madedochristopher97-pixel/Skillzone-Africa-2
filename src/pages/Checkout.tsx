        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-16 items-start">
          ...
          <div className="md:col-span-6 space-y-12">
            ...
            <div className="space-y-8">
              <div className="flex gap-4 p-1 bg-[#f6f3ee] rounded-xl w-fit">
                <button 
                  onClick={() => setPaymentMethod('mpesa')}
                  className={`px-8 py-3 rounded-xl font-bold transition-all ${paymentMethod === 'mpesa' ? 'bg-[#00113a] text-white shadow-sm' : 'text-[#444650] hover:bg-[#f0ede9]'}`}
                >
                  M-Pesa
                </button>
                <button 
                  onClick={() => setPaymentMethod('card')}
                  className={`px-8 py-3 rounded-xl font-bold transition-all ${paymentMethod === 'card' ? 'bg-[#00113a] text-white shadow-sm' : 'text-[#444650] hover:bg-[#f0ede9]'}`}
                >
                  Card
                </button>
                <button 
                  onClick={() => setPaymentMethod('voucher')}
                  className={`px-8 py-3 rounded-xl font-bold transition-all ${paymentMethod === 'voucher' ? 'bg-[#00113a] text-white shadow-sm' : 'text-[#444650] hover:bg-[#f0ede9]'}`}
                >
                  Voucher
                </button>
              </div>
              ...
              {/* M-Pesa Content */}
              {paymentMethod === 'mpesa' && (
                <div className="bg-white p-8 md:p-12 rounded-xl shadow-[0_32px_64px_-12px_rgba(28,28,25,0.06)] border-b-2 border-[#795900]">
